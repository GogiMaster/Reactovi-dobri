...
import item from "../assets/Images/fave1.png";
      ...
      <div className="fave">
        <div className="fave__left">
          ...
          <div className="fave__left__nav">
            <img src={item} /> <h2>Dashboard</h2> <img src={arrow} />
          </div>
          <div className="fave__left__nav">
            <img src={item} /> <h2>Leaderboard</h2> <img src={arrow} />
          </div>
          <div className="fave__left__nav">
            <img src={item} /> <h2>Prizes</h2> <img src={arrow} />
          </div>
          <div className="fave__left__nav">
            <img src={item} /> <h2>Live scores</h2> <img src={arrow} />
          </div>
          <div className="fave__left__nav">
            <img src={item} /> <h2>Game rules</h2> <img src={arrow} />
          </div>
        </div>
        <div className="fave__mid">
          ...
          <div className="fave__mid__title">
            ...
            <p>
              ...
              auctor <br />
              sollicitudin blandit. Duis quis sem a odio euismod maximus.{" "}
            </p>
          </div>
          ...
          <div className="fave__mid__cards">
            ...
            <div className="fave__card">
              <h1>
                Signed Jersey but longer <br /> text in second row
              </h1>
              <p>GAMEWEEK 17</p>
              <h4>Premier League</h4>
              <hr />
